...
tasks {
    ...
    processResources {
        ...
        val stringOwoVersion = libs.versions.owo.get()
    ...
    register<TaskPublishCurseForge>("publishCurseForge") {
        ...
        val file = upload(1037078, remapJar)
        file.displayName = "[${libs.versions.minecraft.get()}] Expanded Crossbow Enchanting"
...
modrinth {
    ...
    projectId = "expanded-crossbow-enchanting"
    uploadFile.set(tasks.remapJar)
    gameVersions.add(libs.versions.minecraft)
    versionName = libs.versions.minecraft.map { "[$it] Expanded Crossbow Enchanting" }
    dependencies {
