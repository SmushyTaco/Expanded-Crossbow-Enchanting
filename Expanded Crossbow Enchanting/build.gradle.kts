...
tasks {
    ...
    register<TaskPublishCurseForge>("publishCurseForge") {
        ...
        file.displayName = "[${project.extra["minecraft_version"] as String}] Expanded Crossbow Enchanting"
...
modrinth {
    ...
    projectId.set("expanded-crossbow-enchanting")
    uploadFile.set(tasks.remapJar)
    gameVersions.addAll(project.extra["minecraft_version"] as String)
    versionName.set("[${project.extra["minecraft_version"] as String}] Expanded Crossbow Enchanting")
    dependencies {
